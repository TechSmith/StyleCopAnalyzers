...
namespace StyleCop.Analyzers.SpacingRules
{
   ...
   /// </remarks>
   [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(TS1005CodeFixProvider))]
    [Shared]
    internal class TS1005CodeFixProvider : CodeFixProvider
    {
        /// <inheritdoc/>
        public override ImmutableArray<string> FixableDiagnosticIds { get; } =
            ImmutableArray.Create(TS1005AssignmentsShouldBeAligned.DiagnosticId);
