...
namespace StyleCop.Analyzers.Test.SpacingRules
{
    ...
    using static StyleCop.Analyzers.Test.Verifiers.StyleCopCodeFixVerifier<
        StyleCop.Analyzers.SpacingRules.TS1000OpeningParenthesisMustBeFollowedByASpace,
        StyleCop.Analyzers.SpacingRules.TokenSpacingCodeFixProvider>;

    /// <summary>
    /// Unit tests for the <see cref="TS1000OpeningParenthesisMustBeFollowedByASpace"/> class.
    /// </summary>
    public class TS1000UnitTests
   {
      [Fact]
...
";
         ...
         var expectedDiagnostic = Diagnostic(DescriptorNotFollowed).WithLocation(8, 15);
